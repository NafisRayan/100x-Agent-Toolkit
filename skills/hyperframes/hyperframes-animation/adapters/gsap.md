...
- `../rules/gsap-effects.md` — drop-in recipes: typewriter (with cursor / backspace / word rotation) + audio visualizer (uses `skills/hyperframes/hyperframes-creative/scripts/extract-audio-data.py`).
