...
and timing on matching `<audio>` elements. `/hyperframes/hyperframes-core` owns this temporal
edit; use `/hyperframes/hyperframes-keyframes` only for visual-property animation such as
...
| ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Any composition HTML or scene layout                                                                              | `/hyperframes/hyperframes-core`; use `references/determinism-rules.md` for its layout contract                                                                                                                                                     |
| Any non-trivial creation or visual treatment                                                                      | `/hyperframes/hyperframes-creative` → `references/house-style.md` and `references/video-composition.md`                                                                                                                                            |
| Any motion, animation, or scene transition                                                                        | `/hyperframes/hyperframes-animation`; follow its routing to the matching rules, adapters, blueprints, or transition references                                                                                                                     |
| `storyboard: yes`                                                                                                 | `../references/storyboard-format.md` and `../references/review-loop.md`                                                                                                                                        |
| Any media asset or operation, including narration, BGM, SFX, captions, grading, or transforms                     | `/hyperframes/media-use`; for framework playback and placement also read `/hyperframes/hyperframes-core` → `references/variables-and-media.md`                                                                                                                 |
| Multi-scene assembly                                                                                              | `../references/production-loop.md`                                                                                                                                                                                         |
| `flow: companion`, before the first plan                                                                          | `/hyperframes/hyperframes-creative` → `references/story-spine.md` and `references/house-style.md`; the nearest genre lens and the full `../references/capability-menu.md` — the ceiling treatment is designed from these, not recalled |
...
| A design spec exists, before final approval                                                                       | `/hyperframes/hyperframes-creative` → `references/design-adherence.md`                                                                                                                                                                             |
...
6. **Assemble.** Mount scenes, media, transitions, captions, and audio using the production loop. Real voice duration overrides estimates. When a music bed plays under any voice track, carve the bed before verifying: `/hyperframes/hyperframes-audio` → `scripts/carve.mjs --comp index.html`. A volume duck alone does not finish the mix.
...
3. Choose an embeddable font pairing from `/hyperframes/hyperframes-creative` → `references/typography.md`; do not assume an unbundled display font exists in cloud rendering.
...
For a named style or mood, read `/hyperframes/hyperframes-creative` → `references/visual-styles.md`. When the user needs to choose visually and no shipped preset fits, read `/hyperframes/hyperframes-creative` → `references/design-picker.md` and run the interactive design selection there.
...
- design adherence is reviewed against `/hyperframes/hyperframes-creative` → `references/design-adherence.md` when a design spec exists;
