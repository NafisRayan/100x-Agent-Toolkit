...
Purely a readability choice for whoever opens the file in Studio. Common patterns, owned by `/hyperframes/hyperframes-studio` (one caption track, one element kind per track).
